document.addEventListener('DOMContentLoaded', function() {
    ...
    sr.reveal('.hero-text h3, .hero-text h1, .hero-text h5, .hero-text p, .social-links, .btn-secondary', { origin: 'left', interval: 100 });
    ...
    sr.reveal('.about-text h3, .about-text h2, .about-text p, .about-text .btn-secondary', { origin: 'right', interval: 100 });
